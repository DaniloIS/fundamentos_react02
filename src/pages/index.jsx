...
export default function Home() {
  return (
    <div style={{
      ...
      <Navigator title='Componente com Estato' href='/state' bgcolor='#a45b71' />
      <Navigator title='Integração com API' href='/integration_one' bgcolor='#42a9a9' />
      <Navigator title='Conteúdo Estático' href='/static' bgcolor='#fa054a' />
    </div>
  ) 
}